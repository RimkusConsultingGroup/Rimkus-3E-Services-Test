...
namespace TE3EEntityFramework.Datasource
{
    ...
    public partial class TE3ERCGSYNCPRODEntities : DbContext
    {
        ...
        public virtual ObjectResult<RetrieveCollectionItemsByPastDueDaysNoFilter_Result> RetrieveCollectionItemsByPastDueDaysNoFilter(Nullable<int> numOfDays)
        {
            var numOfDaysParameter = numOfDays.HasValue ?
                new ObjectParameter("numOfDays", numOfDays) :
                new ObjectParameter("numOfDays", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<RetrieveCollectionItemsByPastDueDaysNoFilter_Result>("RetrieveCollectionItemsByPastDueDaysNoFilter", numOfDaysParameter);
        }
