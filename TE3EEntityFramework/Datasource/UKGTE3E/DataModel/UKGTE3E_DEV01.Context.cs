...
namespace TE3EEntityFramework.Datasource.UKGTE3E.DataModel
{
    ...
    public partial class UKGTE3E_DEV01Entities : DbContext
    {
        public UKGTE3E_DEV01Entities()
            : base("name=UKGTE3E_DEV01Entities")
        {
        }
        ...
        public virtual DbSet<REQUISITION_TE_3E_PO_FORM_DATA> REQUISITION_TE_3E_PO_FORM_DATA { get; set; }
