...
namespace TE3EConnect.te3eMappers.ClientSE
{
    public class CliShortEntryParser
    {
        ...
        public CliShortEntryParser(string[] lines, TE3ETranSvc transSvc, e3eMode e3Mode)
        {
            e3EMode = e3Mode;
            e3EService = transSvc;
            ...
            if (e3EMode == e3eMode.Add)
                ParseAddMatterRec(lines);
            else ParseEditMatterRec(lines);
        }

        private void ParseAddMatterRec(string[] lines)
        {
